...
export default function Mega() {
  ...
  return (
    <div className="my-40 bg-gray-400 py-24">
      <h1 className="text-4xl font-semibold text-center  my-8 text-slate-700  animate-color-change">
        Descovering New Destinations
      </h1>
